...
class localization(Node):
    ...
    def odom_and_pf_pose_callback(self, odom_msg: odom, pf_msg: odom):
        ...
        self.pose=[ pf_msg.pose.pose.orientation.x, pf_msg.pose.pose.orientation.y, euler_from_quaternion(pf_msg.pose.pose.orientation), pf_msg.header.stamp ]
        ...
        odom_values_list = [odom_msg.pose.pose.orientation.x, odom_msg.pose.pose.orientation.y, euler_from_quaternion(odom_msg.pose.pose.orientation), odom_msg.twist.twist.linear.x, odom_msg.twist.twist.angular.z]
        # TODO: pf values: x, y, theta
        pf_values_list = [pf_msg.pose.pose.orientation.x, pf_msg.pose.pose.orientation.y, euler_from_quaternion(pf_msg.pose.pose.orientation)]
